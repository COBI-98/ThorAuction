...
public class ProductController
{
	...
	@GetMapping("list")
	public ModelAndView getSaleProductList(SaleProductVO saleproductVO, KakaoVO kakaoVO, MemberVO memberVO, Authentication authentication)
			throws Exception
	{
		ModelAndView mv = new ModelAndView();
		...
		// 로그인한 정보 보내기
		mv.addObject("getSocialList", kakaoVOs);
		mv.addObject("members", memberVOs);

		if (authentication != null)
		{
			log.info("authentication: {}", authentication.getName());
			mv.addObject("loginID", authentication.getName());
		}
	...
	@GetMapping("detail")
	public ModelAndView getSaleProductListDetail(SaleProductVO saleProductVO, Authentication authentication, HttpSession session)
			throws Exception
	{
		ModelAndView mv = new ModelAndView();
