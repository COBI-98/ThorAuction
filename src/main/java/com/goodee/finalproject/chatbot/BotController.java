	...
	public Map<String,String> message(@RequestParam String str)
	{
		...
		if(str.equals("일반 경매 신청하는 법") || str.equals("실시간 경매 신청하는 법") || str.equals("경매 신청하는 법"))
		{
			...
			content = 
					"<div class='other'>"
                    + "<div class='chat-text'>"
                       + "<p class='text'>경매 신청 승인은 관리자가 수시로 보겠지만 대략 3-5일 정도 걸리는 점 양해부탁드립니다!</p>"
                       +"</div>"
                       +"</div>";
					;
			...
			content = 
					"<div class='other'>"
                    + "<div class='chat-text'>"
                       + "<p class='text'>낙찰 뒤 배송 기간은 대략 1주일 정도 걸리는 점 양해부탁드립니다!</p>"
                       +"</div>"
                       +"</div>";
			...
			content =
					"<div class='other'>"
                    + "<div class='chat-text'>"
                       + "<p class='text'>배송 주소를 잘못 적으셨다면 마이페이지에서 수정해주시면 됩니다!</p>"
                       +"</div>"
                       +"</div>";
					;
			...
			content = 
					"<div class='other'>"
                    + "<div class='chat-text'>"
                       + "<p class='text'>비드코인에서는 포인트를 충전해서 사용하실 수 있습니다.!</p>"
			...
			content = 
					"<div class='other'>"
                    + "<div class='chat-text'>"
                       + "<p class='text'>일반 경매나 실시간 경매에서 포인트로 입찰하여 경매를 즐기실 수 있습니다.</p>"
                       +"</div>"
                       +"</div>";
		}
