									...
									<div class="woocommerce-MyAccount-content">
										...
										<div style="max-width: 800px; margin: 0 auto;" class="msm-profile">
											<div id="mshop_form_2702" class="ui mfs_form " style="">
												<style></style>
												<form action="updatwpw" method="POST" id="updatepw_form" class="ui form" data-id="2702" data-slug="edit_user_profile" data-error_popup="yes" data-type="" onsubmit="return false">                                                     
													<div class="field" style="">
														<label>아이디</label>
                                                        <input type="text" name="id" id="id" value="${memberDB.id}" maxlength="">
													</div>													
													<div class="field" style="">
														<label>현재 비밀번호</label>
                                                        <input type="password" name="pw" id="pw" value="" maxlength="" placeholder="현재 비밀번호를 입력하세요">
													</div>
													<div class="field" style="">
														<label>새 비밀번호</label>
                                                        <input type="password" name="newPassword" id="newPassword" value="" maxlength="" placeholder="새 비밀번호를 입력하세요">
                                                        <div id="newPasswordMsg"></div>
													</div>
													<div class="field" style="">
														<label>새 비밀번호 재확인</label>
                                                        <input type="password" name="newPasswordEquals" id="newPasswordEquals" value="" maxlength="" placeholder="새 비밀번호를 한 번 더 입력하세요">
                                                        <div id="newPasswordEqualsMsg"></div>
													</div>                                                    
                                                    <!-- 저장하기와 폼 사이 선 -->
													...
													<div class="field" style="text-align: center">
														<input id="updatepw_btn" type="button" class="submit ui button submit_btn" name="button" value="수정하기">
													</div>
